      ...
      >
        ...
        <ol className="consent-list">
          <li>
            ...
            <span>
              What you type and say is stored against your account, and each avatar
              remembers what you tell it from one conversation to the next. Your
              conversations with an avatar are read by the person behind it, and by nobody
              else.
            </span>
          </li>
          <li>
            ...
            <span>
              Replies, and what an avatar remembers about you, are generated by a
              third-party model provider. A spoken turn is also transcribed and read aloud
              by a speech service.
            </span>
          </li>
          <li>
